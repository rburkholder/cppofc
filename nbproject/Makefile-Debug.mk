...
${OBJECTDIR}/codecs/ofp_group_mod.o: codecs/ofp_group_mod.cpp
	${MKDIR} -p ${OBJECTDIR}/codecs
	${RM} "$@.d"
	$(COMPILE.cc) -g -DBOOST_ASIO_ENABLE_HANDLER_TRACKING -DBOOST_LOG_DYN_LINK -D_DEBUG -I/usr/local/include -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/codecs/ofp_group_mod.o codecs/ofp_group_mod.cpp
