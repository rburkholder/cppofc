...
${OBJECTDIR}/mac.o: mac.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/mac.o mac.cpp
...
${OBJECTDIR}/protocol/tcp.o: protocol/tcp.cpp
	${MKDIR} -p ${OBJECTDIR}/protocol
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/protocol/tcp.o protocol/tcp.cpp

${OBJECTDIR}/protocol/udp.o: protocol/udp.cpp
	${MKDIR} -p ${OBJECTDIR}/protocol
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/protocol/udp.o protocol/udp.cpp
